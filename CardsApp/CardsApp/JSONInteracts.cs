...
namespace CardsApp
{
    static class JSONInteracts
    {
        ...
        internal static async Task<string> GETJson(string url, string Method ="GET")
        {
        ...
        internal static async Task<TargetType> BasicRequest<TargetType>(string URL, string Method = "GET")
        {
            return await Task.Run(async () => JsonConvert.DeserializeObject<TargetType>(await GETJson(URL, Method)));
        }
